...
class TestLoginPage(unittest.TestCase):
    ...
    def test_create_talent_valid(self):
        ...
        time.sleep(1)
        ev.upload_file_family_01_field("/usr/bin/Promytheus/testdata/painting_demo.jpg")
        time.sleep(2)
        ev.enter_text_in_talent_work_product_field("Testing")
        time.sleep(1)
        ev.upload_file_talent_work_product_field("/usr/bin/Promytheus/testdata/painting_demo.jpg")
        time.sleep(1)
